 ...
 * ({@link me.erykczy.colorfullighting.common.ColoredLightEngine#onLightUpdate()}), so the render
...
public final class DhCompat {
    ...
    public static void onSectionsDirty(me.erykczy.colorfullighting.common.ColoredLightEngine engine, long[] sectionPositions) {
        if (!isLoaded()) return;
