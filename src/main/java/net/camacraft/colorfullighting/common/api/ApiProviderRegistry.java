package net.camacraft.colorfullighting.common.api;

import net.camacraft.colorfullighting.api.CLBlockLightColorProvider;
import net.camacraft.colorfullighting.api.CLEntityLightColorProvider;
