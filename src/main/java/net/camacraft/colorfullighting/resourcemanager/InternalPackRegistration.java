package net.camacraft.colorfullighting.resourcemanager;

import com.mojang.datafixers.util.Pair;
import net.camacraft.colorfullighting.ColorfulLighting;
import net.camacraft.colorfullighting.compat.hbm.HbmCompat;
    ...
    public static void register(IEventBus bus) {
		...
		if (ModList.get().isLoaded("hbm_m")) {
			if (hbmShadersMatchReference()) {
				...
				HbmCompat.setShaderOverrideActive(true);
